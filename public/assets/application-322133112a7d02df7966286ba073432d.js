  ...
  createMarker = function(place, index) {
    ...
    google.maps.event.addListener(marker, 'click', function() {
      ...
      service1.getDetails(request, function(place, status) {
        if (status == google.maps.places.PlacesServiceStatus.OK) {
          infowindow.setContent("<p><img src=" + place.photos[0].getUrl({maxWidth: 150, maxHeight: 150}) + " width='100' height='100' /></p><p><b>" + place.name + "</b></p><p>" + place.formatted_address + "</p><p>" + place.formatted_phone_number + "</p><p>" + place.website + "</p>");
...
// === first support methods that dont (yet) exist in v3
