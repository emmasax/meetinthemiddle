...
//
//   initialize = function() {
//     input1 = document.getElementById("travel_profile_person_1_start"),
//     input2 = document.getElementById("travel_profile_person_2_start"),
...
//         $('#travel_profile_person_1_start').val(optionOrigin);
//         optionDestination = formSetupArray[1].split('=')[1];
//         $('#travel_profile_person_2_start').val(optionDestination);
...
//         $("#travel_profile_person_1_start").attr("data-lat-long", geometry.location.lat() + " " + geometry.location.lng());
//       }
//     });
//     google.maps.event.addListener(autocompleteTo, "place_changed", function() {
//       var geometry = autocompleteTo.getPlace().geometry;
//       if(!(typeof geometry  === 'undefined')) {
//         $("#travel_profile_person_2_start").attr("data-lat-long", geometry.location.lat() + " " + geometry.location.lng());
//       }
//     });
//   },
//
